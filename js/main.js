...
(function () {
  ...
  var PRODUCTS = [
    ...
    {id:"co07",catId:"colaciones",name:"Chapsui de Verdura con Arroz",price:7790,desc:"Verduras salteadas al wok; puede ser con arroz chaufan o blanco.",emoji:"🥬",badges:["vegetariano"]},
    ...
    {id:"mn01",catId:"combos",name:"Menú para 2 Personas A",price:30490,desc:"1 wantán, 1 chapsui de ave, 1 diente de dragón carne, 2 arroz chaufan.",emoji:"🍽️"},
    {id:"mn02",catId:"combos",name:"Menú para 2 Personas B",price:33090,desc:"1 wantán, 1 chapsui de ave, 1 carne mongoliana, 2 arroz chaufan.",emoji:"🍽️"},
    {id:"mn03",catId:"combos",name:"Menú para 3 Personas",price:51090,desc:"1 wantán frito, 1 arrollado primavera, 1 carne mongoliana, 1 diente de dragón pollo, 3 arroz chaufan.",emoji:"🍽️"},
    {id:"mn04",catId:"combos",name:"Menú para 4 Personas",price:66390,desc:"1 wantán frito, 1 arrollado primavera, 1 carne mongoliana, 1 diente de dragón ave, 1 chapsui de carne, 1 pollo mongoliano, 4 arroz chaufan.",emoji:"🍽️"},
    ...
    {id:"mn06",catId:"combos",name:"Menú para 6 Personas",price:95490,desc:"2 wantán frito, 1 arrollado primavera, 1 carne mongoliana, 1 pollo mongoliano, 1 diente de dragón ave, 1 chapsui de carne, 1 chapsui de pollo, 1 arrollado de marisco, 6 arroz chaufan.",emoji:"🍽️"},
    {id:"mn07",catId:"combos",name:"Menú para 7 Personas",price:109890,desc:"2 wantán frito, 1 arrollado primavera, 1 carne mongoliana, 1 pollo mongoliano, 1 costillar cantonés, 1 diente de dragón ave, 1 chapsui de ave, 1 chapsui de carne, 1 arrollado marisco, 7 arroz chaufan.",emoji:"🍽️"},
    {id:"mn08",catId:"combos",name:"Menú para 8 Personas",price:125990,desc:"2 wantán frito, 2 arrollado primavera, 1 carne mongoliana, 1 pollo mongoliano, 1 costillar cantonés, 1 chapsui especial, 1 diente de dragón ave, 1 chapsui de carne, 1 chapsui de pollo, 1 arrollado marisco, 8 arroz chaufan.",emoji:"🍽️"},
    {id:"mn09",catId:"combos",name:"Menú para 9 Personas",price:156690,desc:"2 wantán frito, 2 arrollado primavera, 1 carne mongoliana, 1 pollo mongoliano, 1 costillar cantonés, 1 chapsui especial, 1 pollo chiten, 1 diente de dragón ave, 1 chapsui de carne, 1 chapsui de ave, 1 arrollado marisco, 9 arroz chaufan.",emoji:"🍽️"},
